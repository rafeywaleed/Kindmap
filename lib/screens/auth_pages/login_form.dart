                            ...
                            children: [
                              Align(
                                ...
                                child: Text(
                                  'KindMap',
                                  style:
                                      KMTheme.of(context).displaySmall.copyWith(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            labelText: 'Email',
                            labelStyle:
                                KMTheme.of(context).titleMedium.copyWith(
                                      fontFamily: 'Readex Pro',
                      ...
                      Padding(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            ...
                            debugPrint('Sign in with Google hogaya ');
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    ...
                                    style:
                                        KMTheme.of(context).bodyLarge.copyWith(
                                              fontFamily: 'Readex Pro',
                                              letterSpacing: 0,
                                              fontWeight: FontWeight.bold,
                                            ),
                      ...
                      Padding(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            debugPrint('Sign in with Apple hogaya ');
                          },
                          style: ElevatedButton.styleFrom(
                            backgroundColor:
                                KMTheme.of(context).secondaryBackground,
